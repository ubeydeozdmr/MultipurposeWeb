...
btnSendGuessedNumber.addEventListener('click', function () {
  ...
  if (getGuessedNumber != randomNumber) {
    ...
    document.querySelector('#collapseTwo input');
  }
...
function guessAgain() {
  ...
  document.querySelector('#lives').textContent = 'Lives: ' + lives;
  document.querySelector('#collapseTwo input').value = '';
}
...
const buttonSendTemp = document.querySelector('#button-send-temp');
const flexRadioCtoF = document.querySelector('#flexRadioCtoF');
const flexRadioFtoC = document.querySelector('#flexRadioFtoC');
let resultTemp = document.querySelector('#collapseSix p');
buttonSendTemp.addEventListener('click', function () {
  let temp = tempInput.value;
  if (document.querySelector('#flexRadioCtoF').checked) {
    resultTemp.textContent = 'Result: ' + (temp * 1.8 + 32);
  } else if (document.querySelector('#flexRadioFtoC').checked) {
    resultTemp.textContent = 'Result: ' + (temp - 32) / 1.8;
  }
});
flexRadioCtoF.addEventListener('click', function () {
  tempInput.placeholder = 'Please enter the temperature in celcius';
});
flexRadioFtoC.addEventListener('click', function () {
  tempInput.placeholder = 'Please enter the temperature in fahrenheit';
});
